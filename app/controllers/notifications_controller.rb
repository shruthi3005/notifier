...
def specific_notification_form
    @notification = Notification.new  
  end

  # POST /notifications/notify_in
  def notify_specific_user
    # redirect_to notifications_path, notice: "created successfully."
    ...
    respond_to do |format|
      if @notification.save
        @notification.notify_specific_user(reciever.id)
  ...
  private
    ...
    def notification_params
      params.require(:notification).permit(:title, :content, :mail, :phone, :push, :expiry, :reciever_id)
    end
end
